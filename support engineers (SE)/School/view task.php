...
<head>
 ...
 <div class="menu-bar">
    <ul>
	  ...
	  <li class="active"><a href="view task.php"><i></i>View Tasks</a>
...
<body>
  ...
  <main>
    <div class="container text-center" style="margin-top: 50px;">
      <h1 class="py-4 bg-dark text-light rounded"><i></i><?php //print($_SESSION['company_name']); ?> View Tasks</h1>

      <div class="d-flex justify-content-center" id="divToPrint">
        <?php displayTasksTableView(); ?>
      </div>
