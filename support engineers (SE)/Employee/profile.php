...
<body>
    ...
    <div class="menu-bar">
        <ul>
            ...
            <li><a href="index.php"><i></i>View Tasks</a></li>
    ...
    <main>
        <div class="container text-center" style="margin-top: 50px;">
            <h1 class="py-4 bg-dark text-light rounded"><i></i><?php //print($_SESSION['employee_name']); 
                                                                ?>Employee Details</h1>
            ...
            <div style="margin-top: 50px;" class="d-flex justify-content-center">
                <form action="php/update details script.php" method="post" class="w-50">
                    ...
                    <div class="PT-2">
                        <?php
                        inputElement("<i style='width:150px;'>Employee email</i>", " ", "employee_username", $_SESSION['employee_username']);
                        ?>
                    ...
                    <div class="PT-2">
                        <?php
                        inputElement("<i style='width:150px;'>Employee firstname</i>", "", "employee_firstname", $_SESSION['employee_firstname']);
                        ?>
                    ...
                    <div class="PT-2">
                        <?php
                        inputElement("<i style='width:150px;'>Employee lastname</i>", "", "employee_lastname", $_SESSION['employee_lastname']);
                        ?>
        ...
        <div class="container text-center" style="margin-top: 50px;">
            <h1 style="width:700px;margin:auto" class="py-4 bg-dark text-light rounded"><i></i><?php //print($_SESSION['employee_name']); 
                                                                                                ?>Change Password</h1>
