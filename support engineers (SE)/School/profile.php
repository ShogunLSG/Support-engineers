  ...
  <!-----------------------menu ends---------------------------->
    ...
    <main>
        <div class="container text-center" style="margin-top: 50px;">
            <h1 class="py-4 bg-dark text-light rounded"><i></i><?php //print($_SESSION['school_name']); 
                                                                ?>School Details</h1>
            ...
            <div style="margin-top: 50px;" class="d-flex justify-content-center">
                <form action="php/update details script.php" method="post" class="w-50">
                    ...
                    <div class="PT-2">
                        <?php
                        inputElement("<i style='width:150px;'>School email</i>", " ", "school_username", $_SESSION['school_username']);
                        ?>
                    ...
                    <div class="PT-2">
                        <?php
                        inputElement("<i style='width:150px;'>School name</i>", "", "school_name", $_SESSION['school_name']);
                        ?>
                    ...
                    <div class="PT-2">
                        <?php
                        inputElement("<i style='width:150px;'>School address</i>", " ", "school_address", $_SESSION['school_address']);
                        ?>
        ...
        <div class="container text-center" style="margin-top: 50px;">
            <h1 style="width:700px;margin:auto" class="py-4 bg-dark text-light rounded"><i></i><?php //print($_SESSION['school_name']); 
                                                                                                ?>Change Password</h1>
