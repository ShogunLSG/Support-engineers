...
<div class="menu-bar">
  <ul>
    ...
    <li><a href="index.php"><i class="fa fa-user"></i>Users</li>


    <li class="active"><a href="view task.php"><i></i>View Tasks</a></li>
...
<body>
  ...
  <main>
    <div class="container text-center" style="margin-top: 50px;">
      <h1 class="py-4 bg-dark text-light rounded"><i></i>View Tasks</h1>
